...
def get_repo_info(repo_full_name):
    """
    Get OSINT-style report of a GitHub repository
...
def numlookup_request(mobilenumber):
    if not NUMLOOKUP_API_KEY:
        ...
        return {
            "valid": True,
            "number": mobilenumber,
            "local_format": mobilenumber,
            "international_format": f"+1{mobilenumber}",
            "country_prefix": "+1",
            "country_code": "US",
            ...
            "line_type": "mobile",
            "note": "This is dummy data because NUMLOOKUP_API_KEY is not set."
        }
